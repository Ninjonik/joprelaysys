import { getPiece } from "./runtime-snapshot";
import type { LineblockControl, RuntimeOutcome, RuntimeSnapshot } from "./runtime-types";
...
export function planLineblockAction(snapshot: RuntimeSnapshot, pieceId: string, control: LineblockControl): RuntimeOutcome {
  const piece = getPiece(snapshot, pieceId);
